...
class Navbar extends React.Component {
    ...
    render() {
        return (
            <React.Fragment>
                <nav className="p-3 d-flex align-items-center">
                    ...
                    <ul className="nav mr-auto align-items-center ml-5">
                        ...
                        <li className="new-shipment nav-item mx-4">
