                ...
                <section className="footer ">
                    <div className="container ">
                        <div className="row position-relative">
                            <div className="col-12 popup position-absolute">
                                <div className="pl-4 pr-4 pt-3 pb-3">
                                    <div className="row">
                                        ...
                                        <div className="text-left col-4">
                                            <a href="#" className='w-100 bg-orange btn btn-Form'>افتح حسابك الان</a>
                                        </div>
                                    </div>
                                </div>
                                </div>
                                <div className="col-3 pt-5 mt-5 text-center">
                                    <div className="mb-5">
                                ...
                                <div className="col-2 pt-5 mt-5 text-right">
                                    <h6 className="text-white text-bold">الشركة</h6>
                                    <ul>
                                        <li><a className="text-decoration-none text-white" href="">المدونة</a></li>
                            ...
                            <div className="col-2 pt-5 mt-5 text-right mr-3">
