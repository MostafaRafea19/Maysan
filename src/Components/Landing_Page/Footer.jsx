                        ...
                        <div className="row position-relative">
                            <div className="col-12 mb-sm-5 popup position-absolute">
                                <div className="pl-4 pr-4 pt-3 pb-3">
                                    <div className="row">
                                        <div className='text-md-right col-12 col-md-8 text-center'>
                                            <h3>لا تضيع وقتك ووقت عملائك بعد الان</h3>
                                            <p>النص الشكلي هوا نص لا يحتوي علي اي معنى ويقوم بغرض <br />تصوري فقط لتحديد اماكن النصوص والحاجة منها</p>
                                        </div>
                                        <div className="text-md-right col-12 col-md-4 text-center">
                            ...
                            <div className="col-12 col-md-3  pt-5 mt-5 text-center">
                                ...
                                <div>
                                    <ul className="list-inline">
                                        <li className="list-inline-item mr-3"><a href="#"><svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <li className="list-inline-item mr-3"><a href="#"><svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.958 27.6724C6.35572 27.6724 0.121826 21.4892 0.121826 13.8362C0.121826 6.2339 6.30504 0 13.958 0C21.5603 0 27.7942 6.18322 27.7942 13.8362C27.7942 21.4892 21.5603 27.6724 13.958 27.6724Z" fill="white" />

                                            <svg className="" width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M6.17053 13.4758C6.17053 13.4248 6.47684 13.4758 6.17053 13.4758C6.17053 13.4248 6.22158 13.4758 6.17053 13.4758Z" fill="white" />
                                            </svg>
                            ...
                            <div className="col-6 col-md-2 text-center pt-5 mt-5 text-md-right">
                            ...
                            <div className="col-6 col-md-2 text-center pt-5 mt-5 text-md-right">
                                <h6 className="text-white text-bold">ألربط</h6>
                                <ul>
                            ...
                            <div className="col-6 col-md-2 pt-5 mt-5 text-center text-md-right">
                            ...
                            <div className="col-12 ">
                                <div className="mt-5 ml-5 pl-2">
                                    <img src={visa2} className="" alt=""/>
                                    <img src={visa} className="" alt=""/>
                                </div>
                            </div>
                            <div className="col-12 my-5 text-sm-right">
                                <User_Footer />
                            </div>
