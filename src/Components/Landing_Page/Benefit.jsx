...
class Benefit extends React.Component {
    ...
    render() {
        return ( <
            ...
            p > ما يميزنا انه فى ميسان نسعى دائماً الى توفير الحلول اللوجستية فى الوقت والمكان المناسب نخدم كافة القطاعاتو الانشطة التي تحتاج الى الخدمات اللوجستية لايصال منتجاتها الى عملائها او ارسال الشحنات لاغراض شخصية < /p> < /
            div > <
