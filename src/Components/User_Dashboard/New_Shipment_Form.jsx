...
class New_Shipment_Form extends React.Component {
            ...
            case 1:
                return (
                    <div className="d-flex flex-column justify-content-center align-items-center h-100">
                        <svg className="number-corner align-self-start" width="26" height="32"
                             viewBox="0 0 26 32"
                        ...
                        <p className="py-1 active">بيانات المستلم</p>
                    </div>
                );
            case 2:
                return (
                    <div className="d-flex flex-column justify-content-center align-items-center h-100">
                        ...
                        <p className="py-1 active-2">بيانات المستلم</p>
                    </div>
                );
            default:
                return (
                    <div
                        className="d-flex flex-column justify-content-center align-items-center h-100 pt-4 position-relative">
                        <svg className="number-corner align-self-start position-absolute" width="26" height="32"
                             viewBox="0 0 26 32"
                             fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="py-1">بيانات المستلم</p>
                    </div>
                );
        }
    }
    ...
    componentDidMount() {
        this.props.setHeading('ارسال شحنة جديدة');
    }
            ...
            <React.Fragment>
                <section className="form-shipments m-auto py-3" style={{width: "78%"}}>
                    <div className="container">
                        <div className="row">
                            <section
                                className="send-steps d-flex justify-content-center align-items-center col-12 text-center">
                                <div
                                    ...
                                    <p className={this.state.svg1 == 1 ? "py-1 active" : "py-1 active-2"}>بيانات
                                        المرسل</p>
                                </div>
                                <span
                                ...
                                <div className="h-100 d-flex justify-content-center align-items-center flex-column">
                                    <svg className="number-corner align-self-start" width="25" height="32"
                                         viewBox="0 0 25 32"
                                         fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className={this.state.svg3 == 0 ? "py-1" : "py-1 active"}>محتوى الشحنة</p>
                                </div>
                            </section>
                            <form action="#"
